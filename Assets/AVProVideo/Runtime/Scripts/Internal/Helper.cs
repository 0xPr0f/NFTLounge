...
namespace RenderHeads.Media.AVProVideo
{
	...
	{
		public const string AVProVideoVersion = "2.3.1";
		public sealed class ExpectedPluginVersion
		{
			public const string Windows      = "2.3.0";
			public const string WinRT        = "2.3.0";
			public const string Android      = "2.3.0";
			public const string Apple        = "2.3.0";
		}
